...
import { itemLost } from '@/actions/itemLost'

const foundItem = () => {
    return (
        <>
            <div className="py-10 bg-red-100 h-[83.5vh] bg-[url('/itemDetails.png')] bg-cover">
                <h2 className="text-2xl font-bold text-center">Report Lost Item</h2>
                <div className="shadow-2xl bg-white w-[90%] md:w-[50%] container mx-auto p-5 border border-slate-200 rounded-lg mt-10 opacity-90">

                    <form action={itemLost} className='flex flex-col justify-center items-cente gap-1.5'>
